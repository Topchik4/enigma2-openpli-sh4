...
SystemInfo["HasYPbPr"] = HardwareInfo().get_device_model() in ("hl101", "vip1_v2", "vip2_v1")
SystemInfo["HasScart"] = HardwareInfo().get_device_model() in ("hl101", "vip1_v2", "vip2_v1")
SystemInfo["HasSVideo"] = HardwareInfo().get_device_model() in ("dm8000")
SystemInfo["HasComposite"] = HardwareInfo().get_device_model() in ("hl101", "vip1_v2", "vip2_v1")
