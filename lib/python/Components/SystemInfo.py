...
SystemInfo["HasHDMI-CEC"] =  False
SystemInfo["HasYPbPr"] = HardwareInfo().get_device_model() in ("spark", "vip1_v2", "vip2_v1")
SystemInfo["HasScart"] = HardwareInfo().get_device_model() in ("spark", "vip1_v2", "vip2_v1")
SystemInfo["HasSVideo"] = HardwareInfo().get_device_model() in ("dm8000")
SystemInfo["HasComposite"] = HardwareInfo().get_device_model() in ("spark", "vip1_v2", "vip2_v1")
